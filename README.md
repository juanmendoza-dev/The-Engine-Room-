...
- [Design](docs/superpowers/specs/2026-08-03-engine-room-design.md) — architecture, phases, what's out of scope
- [Build plan](docs/superpowers/plans/2026-08-03-engine-room-implementation.md) — task by task
- [Deployment & branches](docs/deployment.md) — how a branch gets to the live site, who can work in parallel
- [Phase 0 work order](docs/phase-0-engine-spike.md) — the engine spike: what's claimed, which files, what it produces
