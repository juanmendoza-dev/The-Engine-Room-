...
| [`ink-and-bone-preview.html`](ink-and-bone-preview.html) | The approved mockup for the above. Open it directly in a browser — self-contained apart from Google Fonts. Reference only; the shipped design is in `web/app/` and `web/components/`. |
