...
- Two CDP traps cost me time and are worth other agents knowing: enabling the
  ...
  trap the author documented in `scripts/maia-notes.md`.
...
notes already say this (`scripts/maia-notes.md` line 190); the two numbers never
...
5. **Docs cite a dead-ish commit**: `1563b5c` (pre-rebase) in
   `docs/phase-0-engine-spike.md` and the plan doc for what is now `1ffb98a`.
